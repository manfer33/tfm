...
class CartPoleQAgent():
    def __init__(self, buckets=(4,), 
        ...
        self.env = StartOpenAI_ROS_Environment('ArmDroneStabilizeEnv-v0')
        ...
        # self.upper_bounds = [self.env.observation_space.high[0], 0.15, self.env.observation_space.high[2], 3, 0]
        # self.lower_bounds = [self.env.observation_space.low[0], -0.15, self.env.observation_space.low[2], -3, -4]
    ...
    def get_epsilon(self, t):
        ...
        return max(self.min_epsilon, min(1., 1. - math.log10((t + self.decay) / self.decay)))

    def get_learning_rate(self, t):
        """Gets value for learning rate. It declines as we advance in episodes."""
        # Learning rate also declines as we add more episodes        
        return max(self.min_lr, min(1., 1. - math.log10((t + self.decay) / self.decay)))
